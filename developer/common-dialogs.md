...
*Figure 67. URL File Dialog - Local files*
> [!NOTE]
...
*Figure 68. URL File Dialog - Workspace view*
...
*Figure 69. URL File Dialog - CloverDX Server*
...
*Figure 70. URL File Dialog - Hadoop HDFS*
...
*Figure 71. Configuration of OpenSSH file location*
...
*Figure 72. Example of enerated OpenSSH private key*
...
For list of regions and endpoints, see *[AWS Regions and Endpoints (Amazon S3)](http://docs.aws.amazon.com/general/latest/gr/rande.html#s3_region)*.
...
For detailed information, see the [Walkthrough: Using IAM roles for EC2 instances](https://docs.aws.amazon.com/sdk-for-java/v1/developer-guide/java-dg-roles.html#roles-walkthrough).
> [!TIP]
> These sources of credentials may be used for graph development in a local project; for example, set `aws.accessKeyId` and `aws.secretKey` Java system properties (for CloverDX Runtime) and add them to `CloverDXDesigner.ini` (for File URL dialog) so that graphs work in local projects when using S3 URLs without credentials.
...
1. **Storage Shared Key**
   ...
   *Figure 73. Storage Account Access Keys*
...
2. **Client Secret**
   ...
   *Figure 74. Tenant ID and Client ID*
   ...
   *Figure 75. Certificates & secrets*
...
5. **Anonymous**
   ...
   *Figure 77. URL File Dialog - Remote files*
...
*Figure 78. URL File Dialog - Input Port*

![file url dialog 018b](../figures/file-url-dialog-018b.png)
*Figure 79. URL File Dialog - Output Port*
...
*Figure 80. URL File Dialog - Dictionary*
