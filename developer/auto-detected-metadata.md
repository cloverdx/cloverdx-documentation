...
*Figure 233. Metadata propagation: metadata is propagated from the first edge on the left side to all connected edges.*
...
*Figure 234. Changing auto-propagated metadata to user-defined.*

![auto detected metadata 007](../figures/auto-detected_metadata_007.png)
*Figure 235. Changing user-defined metadata to auto-propagated.*
...
*Figure 236. Different priorities of metadata propagation*
...
*Figure 237. Metadata propagated from the component*

![auto detected metadata 015](../figures/auto-detected_metadata_015.png)
*Figure 238. Metadata propagated from the component II.*

![auto detected metadata 017](../figures/auto-detected_metadata_017.png)
*Figure 239. Metadata propagated from the component, metadata template is defined within the component.*
...
*Figure 240. Metadata propagated from the another edge*

![auto detected metadata 04](../figures/auto-detected_metadata_04.png)
*Figure 241. Metadata propagated from a distant edge*

![auto detected metadata 045](../figures/auto-detected_metadata_045.png)
*Figure 242. Advanced metadata propagation - DataIntersection*
...
*Figure 243. Overview of directions of metadata propagation*
...
*Figure 244. Metadata propagated from an unconnected distant edge*
...
*Figure 245. Metadata propagated from another edge*
> [!NOTE]
