...
*Figure 86. Import CloverDX Project from URL dialog*
...
*Figure 88. Import from CloverDX Server sandbox wizard (Connect to CloverDX Server)*
...
*Figure 89. Import from CloverDX Server sandbox wizard (List of files)*
...
*Figure 91. Import metadata from XSD*
...
*Figure 92. Import metadata from XSD - Review*
...
*Figure 93. Import Metadata from DDL*
