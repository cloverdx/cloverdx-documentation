...
Example 353. Usage of addDataSetReloadNotification
...
Example 354. Usage of addResponseHeader
...
Example 355. Usage of containsResponseHeader
...
Example 356. Usage of getRequestBody
...
Example 357. Usage of getRequestCertificateProperties If a CloverDX Server is configured to require client certificate the `getRequestCertificateProperties()` returns map containing certificate properties.
...
Example 358. Usage of getRequestClientIPAddress If you run the CloverDX Server locally, the `getRequestClientIPAddress()` returns IP address corresponding to localhost: `"127.0.0.1"` or `"0:0:0:0:0:0:0:1"`.
...
Example 359. Usage of getRequestContentType
...
Example 360. Usage of getRequestEncoding
...
Example 361. Usage of getRequestHeader
...
Example 362. Usage of getRequestHeaderNames
...
Example 363. Usage of getRequestHeaders
If you query the data service with>
...
Example 364. Usage of getRequestMethod
If you query the data service with:
...
Example 365. Usage of getRequestParameter
If you query the data service with:
...
Example 366. Usage of getRequestParameterNames
If you query the data service with:
...
The function `getRequestParameters()` was introduced in **CloverETL 4.7.0-M1**.
Example 367. Usage of getRequestParameters
If you query data service with:
...
Example 368. Usage of getRequestPartFilename
...
Example 369. Usage of getResponseContentType The `getResponseContentType()` returns for example `application/json`.
...
Example 370. Usage of getResponseEncoding E.g. the `getResponseEncoding()` returns `iso-8859-1`.
...
Example 371. Usage of setRequestEncoding
...
Example 372. Usage of getResponseBody The `setResponseBody("The response")` sets the response body.
...
Example 373. Usage of setResponseContentType`setResponseContentType("text/plain");`
...
Example 374. Usage of setResponseEncoding The `setResponseEncoding("UTF-8");` sets response body encoding to *UTF-8*.
...
Example 375. Usage of setResponseHeader`setResponseHeader("Server", "BOA")`
**See also:**[addResponseHeader](http-ctl2.html#id_ctl2_addresponseheader)
...
Example 376. Usage of setResponseStatus
