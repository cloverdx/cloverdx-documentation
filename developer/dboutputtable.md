...
- **The Query Contains Question Marks**
  ...
  See also [SQL Query Editor](dboutputtable.md#sql-query-editor).
  Example 372. Examples of Insert Queries
  | Statement | Form |
  | --- | --- |
  ...
  | --- | --- |
  Example 373. Examples of Update and Delete Queries
  | Statement | Form |
  | --- | --- |
...
*Figure 364. Generated query with question marks*
...
*Figure 365. Generated query with input fields*
...
*Figure 366. Generated query with returned fields*
