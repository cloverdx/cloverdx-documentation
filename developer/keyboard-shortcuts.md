...
- Ctrl+H - open **Search dialog**. See [Search Functionality](search-functionality.md).
...
- F11 - debug.
- Shift+Space - open **Add component** dialog. See [Adding components](components.md#adding-components).
- Shift+D - disable component. See [Enable/Disable component](components.md#enabledisable-component).
- Shift+E - enable component. See [Enable/Disable component](components.md#enabledisable-component).
- Shift+T - disable as Trash. See [Enable/Disable component](components.md#enabledisable-component).
