...
## 1. First steps with CloverDX Designer
...
You can also use **CloverDX AI Assistant** from the Designer. The Assistant is an AI-powered

**CloverDX AI Assistant** is an agentic collaborator embedded into the Designer. It can collaborate with you on variety of tasks – solution architecture, job development, debugging, documentation and more. Learn more about the Assistant [here](designer-ai-assistant.md) or follow our [quick start guide](designer-ai-assistant.md#ai-assistant-quick-start) to quickly get up to speed on the Assistant usage. Or simply ask the Assistant to help you.
...
![example graph](../figures/example-graph.png)
