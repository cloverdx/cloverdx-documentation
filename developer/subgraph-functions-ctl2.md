...
Example 335. Usage of getSubgraphInputPortsCount There is a subgraph having two input ports and one output port. The function `getSubgraphInputPortsCount()` returns `2`.
...
Example 336. Usage of getSubgraphOutputPortsCount There is a subgraph having two input ports and one output port. The function `getSubgraphOutputPortsCount()` returns `1`.
...
Example 337. Usage of isSubgraphInputPortConnected
...
Example 338. Usage of isSubgraphOutputPortConnected
