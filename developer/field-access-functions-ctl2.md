...
Example 274. Usage of copyByName
...
Example 275. Usage of copyByPosition There are two records. The input record has fields `field1`, `field2` and `field3`. The output record has fields `firstField` and `lastField`. The function `copyByPosition($out.0, $in.0)` copies value from `field1` to `firstField` and from `field2` to `lastField`.
...
Example 276. Usage of getBoolValue
...
Example 277. Usage of getByteValue
...
Example 278. Usage of getDateValue
...
Example 279. Usage of DecimalValue
...
Example 280. Usage of getFieldIndex
...
Example 281. Usage of getFieldLabel
...
Example 282. Usage of getFieldName
...
Example 283. Usage of getFieldProperties
...
Example 284. Usage of getFieldType There is a record having first field of data type `string`. The function `getFieldType($in.0, 0)` returns `string`.
...
Example 285. Usage of getIntValue
...
Example 286. Usage of getLongValue
...
Example 287. Usage of getNumValue
...
Example 288. Usage of getRecordProperties
...
Example 289. Usage of getStringValue
...
Example 291. Usage of getValueAsString
...
Example 293. Usage of length There is an input record having 14 fields. The function `length($in.0)` returns `14`.
...
Example 294. Usage of resetRecord
...
Example 295. Usage of setBoolValue
...
Example 296. Usage of setByteValue
There is a record of booleans having fields `field1` and `field2`.
...
Example 297. Usage of setDateValue
...
Example 298. Usage of seDecimalValue
...
Example 299. Usage of setIntValue
...
Example 300. Usage of setLongValue
...
Example 301. Usage of setNumValue
...
Example 302. Usage of setStringValue
