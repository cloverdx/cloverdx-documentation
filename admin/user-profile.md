...
![user profile menu](../figures/user-profile-menu.png)
...
*Figure 93. User profile details*

To update your first name, last name, or email use the ![icon pencil button](../figures/icon-pencil-button.png) button.

To update your credentials, use the ![icon key button](../figures/icon-key-button.png) button. To change your password, you are required to enter your current password. Refer [here](users.md#user-password) for password requirements.
