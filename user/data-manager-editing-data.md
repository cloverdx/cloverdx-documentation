...
*Figure 174. Data Editor screen for transactional data sets showing the data grid and audit side bar.*
...
*Figure 175. Colors in the data grid provide additional information about the row.*
...
*Figure 176. Colors in the data grid provide additional information about the row.*
...
*Figure 177. Audit log showing events for a single row.*
...
*Figure 178. Data grid header showing data sorted by the State column and then by the City column.*
...
*Figure 179. User interface elements on the data editor screen that allow you to configure variety of filters.*
...
*Figure 180. Screenshot showing global search with highlighted occurrences of the search string.*
...
*Figure 181. Data editor with expanded value filters showing filters on Postal code and Date of Birth columns.*
...
*Figure 182. Column chooser allows you to select which columns to show and their order. It can be shown by clicking on the icon to the left of the full text search.*
...
*Figure 183. Data exported from the Data Manager via the Export to Excel function.*
